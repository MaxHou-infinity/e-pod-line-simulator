...
- **人力规划（V3.2）**：目标产量反推人力、多班次/成本/招聘缺口/爬坡达产，HRBP/HR 可导出 Excel/PDF
- **三业态深化（V3.2）**：烟油罐容/批次排产/CIP/原料库存、组装 BOM/缺料/返工、尼古丁袋 OEE 分解/换型矩阵
- **智能评估（V3.2）**：KPI 历史趋势、批量试算、敏感性扩展、遗传算法智能优化
...
1. 解压 `E-Pod-Line-Simulator-v3.2.0.zip`；
